...
IUSE="abi_mips_n32 audit bindist debug hpn kerberos kernel_linux ldns libedit livecd obfuscated pam +pie +scp sctp security-key selinux +ssl static test X X509 xmss"
