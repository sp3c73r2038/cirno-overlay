...
# request-id (https://github.com/aleiphoenix/nginx-x-rid-header)
RID_HEADER_MODULE_PV="master"
RID_HEADER_MODULE_P="nginx-x-rid-header-${RID_HEADER_MODULE_PV}"
RID_HEADER_MODULE_URI="https://github.com/aleiphoenix/nginx-x-rid-header/archive/${RID_HEADER_MODULE_PV}.tar.gz"
RID_HEADER_MODULE_WD="${WORKDIR}/nginx-x-rid-header-${RID_HEADER_MODULE_PV}"
...
SRC_URI="http://nginx.org/download/${P}.tar.gz
	...
	nginx_modules_rid_header? ( ${RID_HEADER_MODULE_URI} -> ${RID_HEADER_MODULE_P}.tar.gz )"
...
CDEPEND="
	...
	nginx_modules_rid_header? ( dev-libs/ossp-uuid )"
...
src_configure() {
	...
	if use nginx_modules_rid_header ; then
		http_enabled=1
		myconf+=" --add-module=${RID_HEADER_MODULE_WD}"
		myldconf+=" -lossp-uuid"
	fi
