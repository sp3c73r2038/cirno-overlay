...
inherit eutils fdo-mime gnome2-utils l10n python-single-r1 git-2

DESCRIPTION="A GTK image viewer specifically designed to handle comic books."
HOMEPAGE="https://github.com/HoverHell/Comix"
EGIT_REPO_URI="git://github.com/HoverHell/Comix"
...
RDEPEND="${DEPEND}
	...
	lzma? ( dev-python/pylzma[${PYTHON_USEDEP}] )"
